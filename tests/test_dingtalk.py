...
class TestDingTalkRobot(unittest.TestCase):
    def setUp(self):
        access_token = "cdeed2cba96e0eb5c0c080dfbde571fea58e6db64945a4041ba7dfb9671fe1e0"
    ...
    def test_link_msg(self):
        ...
        pic_url = "https://www.python.org/static/community_logos/python-powered-h-140x182.png"
    ...
    def test_single_btn_actioncard_msg(self):
        ...
        resp = self.robot.send_actioncard_msg(title, text, btn, hide_avatar=True)
    ...
    def test_multi_btns_actioncard_msg(self):
        ...
        btns = [("Red pill", "https://m.google.com/"), ("Blue pill", "https://m.baidu.com")]
        resp = self.robot.send_actioncard_msg(title, text, *btns, vertical_btns=False, single_btn=False)
